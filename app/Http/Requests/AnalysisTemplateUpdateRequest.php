...
class AnalysisTemplateUpdateRequest extends FormRequest
{
    ...
    {
        $template = $this->route('analysis_template');
        return $template instanceof AnalysisTemplate
    ...
    public function rules(): array
    {
        ...
        return [
            'indicator_id' => [
                ...
                Rule::unique('analysis_templates', 'indicator_id')->ignore($template->id),
            ],
