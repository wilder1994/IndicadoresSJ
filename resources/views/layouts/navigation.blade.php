<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('indicators.index')" :active="request()->routeIs('indicators.*')">
                        {{ __('Indicadores') }}
                    </x-nav-link>
                    ...
                    @if (auth()->user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.mother.index')" :active="request()->routeIs('admin.mother.*')">
                            {{ __('MADRE') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.dashboard.index')" :active="request()->routeIs('admin.dashboard.*')">
                            {{ __('Dashboard Ops') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.settings.weights.edit')" :active="request()->routeIs('admin.settings.*')">
                            {{ __('Configuracion') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('indicators.index')" :active="request()->routeIs('indicators.*')">
                {{ __('Indicadores') }}
            </x-responsive-nav-link>
            ...
            @if (auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.mother.index')" :active="request()->routeIs('admin.mother.*')">
                    {{ __('MADRE') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.dashboard.index')" :active="request()->routeIs('admin.dashboard.*')">
                    {{ __('Dashboard Ops') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.settings.weights.edit')" :active="request()->routeIs('admin.settings.*')">
                    {{ __('Configuracion') }}
                </x-responsive-nav-link>
